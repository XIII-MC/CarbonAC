package com.xiii.carbon.api.events;
...
public class CarbonViolationEvent extends Event implements Cancellable {

    private static final HandlerList handlers = new HandlerList();

    private final Player player;
    private final String checkName, description, type, information;
    private final int vl, maxVl;
     ...
     */
    public CarbonViolationEvent(Player player, String checkName, String description, String type, String information,
